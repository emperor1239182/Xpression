...
const Shop = () => {
    ...
    return (
        ...
        <div style={shop}>
            ...
            <br /> <br />
                <Link to="/skirt" className='link'> <img src="/public/hf.JPG" style={productsImages}></img> 
            ...
            <li>
            <br /> <br />
                <Link to="/buy" className='link'> <img src="/public/green joggers.JPG" style={productsImages}></img>  
            ...
            <li>
            <br /> <br />
                <Link to="/buy" className='link'> <img src="/public/armless.JPG" style={productsImages}></img>
            ...
            <li>
            <br /> <br />
                <Link to="/buy" className='link'> <img src="/public/white vintage.JPG" style={productsImages}></img>  
            ...
            <li>
                <br/> <br />
                <Link to="/buy" className="link "> <img src="/public/jeans up and down.JPG" style={productsImages}></img> 
            ...
            <li>
                <br/> <br />
                <Link to="/buy" className="link "> <img src="/public/TTIO8506.JPG" style={productsImages}></img> 
            ...
            <li>
                <br/> <br />
                <Link to="/buy" className="link "> <img src="/public/PGGY2062.JPG" style={productsImages}></img> 
            ...
            <li>
                <br/> <br />
                <Link to="/buy" className="link "> <img src="/public/LXLK6631.JPG" style={productsImages}></img> 
            ...
            <li>
                <br/> <br />
                <Link to="/buy" className="link "> <img src="/public/KVJJ2447.JPG" style={productsImages}></img> 
            ...
            <li>
                <br/> <br />
                <Link to="/buy" className="link "> <img src="/public/women jeans.JPG" style={productsImages}></img> 
            ...
            <li>
                <br/> <br />
                <Link to="/buy" className="link "> <img src="/public/black armless.JPG" style={productsImages}></img> 
                <p className="productName" style={{fontSize: '13.8px'}}>Two Piece</p>
                <p className="price">$9000</p>
                </Link>
            </li>
